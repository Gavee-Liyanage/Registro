...
<div class="navbar">
    ...
    <div class="container mt-5">
        <h2 class="h1 mb-4">View Admin Data</h2>


    <!-- Add Admin Button -->
    <div class="d-flex justify-content-end mb-3">
        <a href="add_admin.php" class="btn btn-success btn-lg">
                ...
                <?php if ($result && $result->num_rows > 0): ?>
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td>
                            <a href="update_admin.php?id=<?php echo $row['admin_Id']; ?>" class="btn btn-primary btn-sm">
                                <i class="fas fa-edit"></i> Update
                            </a>
                            <a href="delete_admin.php?id=<?php echo $row['admin_Id']; ?>" class="btn btn-danger btn-sm" 
