...
if (isset($_GET['search'])) {
    ...
    $query = "SELECT * FROM panel_member WHERE CONCAT(panel_id, member_name, panel_contact, panel_email) LIKE '%$filtervalues%'";
...
<head>
    ...
    <title>Panel Member Search</title>
...
<body>
    ...
    <div class="container mt-5">
        <h2 class="h1 mb-4">Search Panel Member Data</h2>
